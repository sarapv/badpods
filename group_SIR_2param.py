...
_PARAM_DIM = 2   # parameter dimension (beta1, gamma1, beta2, gamma2)
_OBS_DIM = 2     # observation dimension (y1, y2)
_BETA2 = 0.55  # default beta2 value for 1-parameter model
_GAMMA2 = 0.15  # default gamma2 value for 1-parameter model
...
def config_param(N_parameter):
    ...
    cte_jittering = jnp.array([2, 2]) / (N_parameter ** 1.5)
...
def init_param_particles(subkey, N_parameter):
    ...
    return jnp.concatenate((beta1, gamma1), axis=1)
